...
Game.create(name:"sonic the hedgehog", console: "sega megadrive", year: "1991", price_per_day: 2, genre: "action" )
# Game.create(name:"super marioworld", console: "super nintendo", year: "1990", price_per_day: 2, genre: "action", user: user_one )
