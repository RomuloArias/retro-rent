...
game_a = Game.create!(name:"sonic the hedgehog", console: "sega megadrive", year: 1991, price_per_day: 2, genre: "action", user: user_one)
...
game_d = Game.create(name:"wonder boy", console: "sega mastersystem", year: 1986, price_per_day: 4, genre: "adventure", user: user_two)
game_e = Game.create(name:"pac-man", console: "atari", year: "1980", price_per_day: 3, genre: "retro", user: user_three)
...
game_h = Game.create(name:"mortal combat", console: "sega megadrive", year: 1996, price_per_day: 3, genre: "combat", user: user_four)
